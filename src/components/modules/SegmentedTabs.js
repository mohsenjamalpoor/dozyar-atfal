...
const TONES = {
  brand: {
    ...
    off: "border-brand-200 bg-white text-brand-700 hover:bg-brand-50",
  },
  red: {
    on: "border-red-700 bg-red-700 text-white shadow-lg shadow-red-700/30",
    off: "border-red-300 bg-white text-red-700 hover:bg-red-50",
  },
  blue: {
    on: "border-blue-700 bg-blue-700 text-white shadow-lg shadow-blue-700/30",
    off: "border-blue-300 bg-white text-blue-700 hover:bg-blue-50",
  },
};
